 ...
 */
class LinkedProductsBehavior extends \yii\base\Behavior
{
	public $referenceModelClass = 'common\models\ShopProductRelations'; // класс промежуточной таблицы
	...
	public $linkedModelClass = 'common\models\ShopProduct'; // класс модели представляющей прилинкованные товары
	public $linksModelClass = 'common\models\ShopRelation'; // класс модели списка возможных связей
