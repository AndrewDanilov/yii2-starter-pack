...
class OrderForm extends Model
{
	...
	{
		return [
			[['name', 'email', 'phone', 'city', 'street', 'house', 'appartment', 'delivery_id', 'pay_id'], 'required'],
			[['email'], 'validateEmail'],
			[['delivery_id', 'pay_id'], 'integer'],
			[['name', 'email', 'phone', 'postindex', 'city', 'street', 'house', 'block', 'building', 'appartment', 'organization', 'inn'], 'string', 'max' => 255],
		];
	}
